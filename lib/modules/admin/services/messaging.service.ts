...
export class MessagingService {
     ...
     */
    async sendToDevice(token: string, payload: Partial<Message>): Promise<string> {
     ...
     */
    async sendToDevices(tokens: string[], payload: Partial<MulticastMessage>): Promise<MessagingBatchResponse> {
     ...
     * @returns Promise that resolves with the message ID
     */
    async sendToTopic(topic: string, payload: Partial<TopicMessage>): Promise<string> {
