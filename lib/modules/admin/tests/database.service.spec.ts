...
describe('DatabaseService', () => {
    ...
    describe('set', () => {
        ...
        it('should handle error during set operation', async () => {
            ...
            await expect(service.set('error-path', { test: 'data' }))
        ...
        it('should set primitive data types', async () => {
            // String
            await expect(service.set('string-path', 'test-string')).resolves.not.toThrow();
    ...
    describe('update', () => {
        ...
        it('should handle error during update operation', async () => {
            ...
            await expect(service.update('error-path', { name: 'test' }))
    ...
    describe('remove', () => {
        ...
        it('should handle error during remove operation', async () => {
            ...
            await expect(service.remove('error-path'))
    ...
    describe('push', () => {
        ...
        it('should handle error during push operation', async () => {
            ...
            await expect(service.push('error-path', { name: 'test' }))
        ...
        it('should push different data types', async () => {
            // Object
            await expect(service.push('list/objects', { id: 1 })).resolves.toBe('mock-key');

            // Array
            await expect(service.push('list/arrays', [1, 2, 3])).resolves.toBe('mock-key');

            // String
            await expect(service.push('list/strings', 'test string')).resolves.toBe('mock-key');
