...
export class FirestoreService {
     ...
     */
    async set<T = DocumentData>(path: string, data: WithFieldValue<T>, options?: SetOptions): Promise<void> {
        if (options) {
     ...
     */
    async update<T = DocumentData>(path: string, data: Record<string, any>): Promise<void> {
     ...
     */
    async add<T = DocumentData>(collectionPath: string, data: WithFieldValue<T>): Promise<DocumentReference<T>> {
     ...
     */
    async query<T = DocumentData>(collectionPath: string, ...constraints: any[]): Promise<T[]> {
